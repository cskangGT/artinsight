...
export const ExcuseMeVerticallyPXLittle = styled(View)`
  height: 10px;
`
export const ExcuseMeVerticallyPXMedium = styled(View)`
  height: 50px;
`
export const ExcuseMeVerticallyMedium = styled(View)`
  height: 5%;
`